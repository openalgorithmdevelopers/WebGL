var WebGL = function () {
	...
	[	 //X 	  Y 	Z       R  G  B
		 -0.3,	-0.5,	0,		1, 0, 0,	//Vertex A  
		 -0.3,	0.2,	0,      1, 0, 0,	//Vertex B
		 -0.3,	0.2,	0,      0, 1, 0, 	//Vertex B'
		 -0.3,	0.2,	0,      0, 0, 1,  	//Vertex B''
		  0, 	0.7,	0,      0, 0, 1,	//Vertex C
		  0.3,	0.2,	0,      0, 0, 1,	//Vertex D
		  0.3,	0.2,	0,      0, 1, 0,	//Vertex D'
		  0.3,	-0.5,	0,      0, 1, 0,	//Vertex E
		  0.3,	-0.5,	0,      1, 0, 0		//Vertex E'
	];  

	//Step 3 (Specify how to connect the points): Specify the order with which the coordinates defined in Step2 will be joined.
	var IndicesArrayJS =
	[// A-0, B-1, B'-2, B''-3, C-4, D-5, D'-6, E-7, E'-8
		0,	1,	8, 	//Red colored
		2,	6,	7,	//Green colored
		3,	4,	5	//Blue colored
	];
