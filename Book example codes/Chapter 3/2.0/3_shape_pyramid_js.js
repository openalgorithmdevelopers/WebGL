var WebGL = function () {
	...
	//Step 2 (Speficy vertices data): Speficy the coordinates (X,Y,Z) of the pyramid
	...
	var IndicesArrayJS =
	[
		// To draw outline only of the pyramid use this index array, use gl.LINES also in Step 18
		//A-0, B-1, C-2, D-3
		0, 3,	// Line 1: AD
		3, 2, 	// Line 2: DC		
		2, 0, 	// Line 3: CA
...
/*  	var IndicesArrayJS =
	[
		// To draw filled pyramid use this index array, use gl.TRIANGLES also in Step 18. 
		//A-0, B-1, C-2, D-3
	...
	gl.drawElements(gl.LINES, IndicesArrayJS.length, gl.UNSIGNED_SHORT, 0); // To draw outline only of the pyramid use this code, along with correct index array specification in Step 3.
	//gl.drawElements(gl.TRIANGLES, IndicesArrayJS.length, gl.UNSIGNED_SHORT, 0); // To draw outline only of the pyramid use this code, along with correct index array specification in Step 3.
};
