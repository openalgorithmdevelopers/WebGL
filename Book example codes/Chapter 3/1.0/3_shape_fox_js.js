var WebGL = function () {
	...
	//Step 2 (Speficy vertices data): Speficy the coordinates (X,Y,Z) of the fox
	...
	[
		...
		1, 2, 3, 	// TRIANGLE 2: BCD		
		2, 4, 3, 	// TRIANGLE 3: CED
		7, 5, 6, 	// TRIANGLE 4: HFG
		5, 8, 9, 	// TRIANGLE 5: FIJ
		10, 11, 12, // TRIANGLE 6 : KLM
		13, 15, 11, // TRIANGLE 7 : NPL
		13, 14, 15	// TRIANGLE 8 : NOP
	];
...
function getShaderProgram(gl)
{
	...
	' void main() ' +
	' { ' +
	'  		gl_FragColor = vec4(0.6, 0.34, 0.16, 1); ' +
	' } ';
