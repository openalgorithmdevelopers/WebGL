var WebGL = function () {
	...
	[//  X, 	 Y,	 	Z		U, V
    	-0.5,	0.8,	0,  	0, 0,	//Vertex A
        0.5, 	0.8, 	0,  	1, 0,	//Vertex B
        0.5, 	-0.8, 	0,  	1, 1,	//Vertex C
        -0.5, 	-0.8, 	0,  	0, 1	//Vertex D
	];  
...
function getShaderProgram(gl)
{
	...
	'	attribute vec3 geometryCoordinatesVS; ' +
	'	attribute vec2 textureInfoVS; ' +
	'	varying vec2 textureInfoVS_for_FS; ' +
	'	void main() ' +
	'	{ ' +
    ...
    ' 	void main() ' +
    ' 	{ ' +
    '  		gl_FragColor = texture2D(sampler, textureInfoVS_for_FS); ' +
    ' 	} ';
